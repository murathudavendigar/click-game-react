      ...
      <div className="my-6 text-center">
        {userName.trim() ? (
          <input
            type="text"
            id="success"
            className="bg-green-100 border border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 text-xl rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-3"
          ...
          <input
            type="text"
            id="success"
            className="bg-red-100 border border-red-500 text-red-900 dark:text-red-400 placeholder-red-700 text-xl rounded-lg focus:outline-none focus:ring-red-500 focus:border-red-500 block w-full p-3"
            placeholder="Enter Your Username"
            onChange={(e) => setUserName(e.target.value)}
          />
        )}
